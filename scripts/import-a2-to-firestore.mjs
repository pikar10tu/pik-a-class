...
async function main() {
  ...
  // 1. IMPORT EXERCISES
  console.log('\n--- 1. IMPORTING A2 REMAINING EXERCISES ---');
  ...
  const rawExercises = JSON.parse(readFileSync('docs/seeds/a2-full-exercises.json', 'utf8'));
  console.log(`Read ${rawExercises.length} exercises from a2-full-exercises.json.`);
  ...
  // 2. IMPORT STAGES
  console.log('\n--- 2. IMPORTING A2 STAGES (11 TO 20) ---');
  ...
  const rawStages = JSON.parse(readFileSync('docs/seeds/a2-full-stages.json', 'utf8'));
  console.log(`Read ${rawStages.length} stages from a2-full-stages.json.`);
  ...
  console.log('\n========================================');
  console.log('All A2 content successfully deployed and published in Firestore!');
