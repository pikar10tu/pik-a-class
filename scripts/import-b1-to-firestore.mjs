...
async function main() {
  ...
  // 1. IMPORT EXERCISES
  console.log('\n--- 1. IMPORTING B1 EXERCISES (150 ITEMS) ---');
  ...
  const rawExercises = JSON.parse(readFileSync('docs/seeds/b1-full-exercises.json', 'utf8'));
  console.log(`Read ${rawExercises.length} exercises from b1-full-exercises.json.`);
  ...
  const rawStages = JSON.parse(readFileSync('docs/seeds/b1-full-stages.json', 'utf8'));
  console.log(`Read ${rawStages.length} stages from b1-full-stages.json.`);
  ...
  console.log('\n========================================');
  console.log('All B1 content successfully deployed and published in Firestore!');
